      ...
      <div class="detail_wrap">
        <div class="detail_img"
          ...
          <div class="item-thumbs"
            ...
            <div class="bd">
              <div class="tempWrap"
                   style="overflow:hidden; position:relative; width:330px">
                <ul class="cle"
                    style="width: 330px; position: relative; overflow: hidden; padding: 0px; margin: 0px; left: 0px;">
                  <li v-for="(item,index) in proDetail.images"
                      :key="index"
          ...
          <dl class="loaded">
            ...
            <dd class="property">
              <ul>
                ...
                <li>
                  <span class="icon_promo">抢购</span> <span class="lbl">促销价</span><span class="unit"> <strong class="nala_price red"
                            id="ECS_SHOPPRICE">￥{{proDetail.shop_price}}元</strong> </span> <span class="timedown"
                        id="timedown"></span>
                </li>
                <li>
            ...
            <dd class="tobuy-box cle">
              <ul class="sku">
                <li class="skunum_li cle">
                  ...
                  <div class="skunum"
                       id="skunum"> <span class="minus"
                          title="减少1个数量"
                          @click="reduceNum"><i class="iconfont">-</i></span>
                    <input id="number"
                           name="number"
                           type="text"
                           min="1"
                    ...
                    <span class="add"
                          title="增加1个数量"
                          @click="addNum"><i class="iconfont">+</i></span> <cite class="storage"> 件 </cite>
                  </div>
                  <div class="skunum"
                       id="skunum">
...
export default {
  ...
  methods: {
    ...
    ImagePrev () {
      ...
      this.replaceShow(this.curIndex, this.proDetail.images[this.curIndex])
    },
    ImageNext () {
...
.spxq_main table td div,
.spxq_main table td span {
  display: block;
  margin-bottom: 4px;
}
.spxq_main h3 {
...
.item-thumbs a.left_btn:hover,
.item-thumbs a.right_btn:hover {
  text-decoration: none;
  color: #ccc;
}
.item-thumbs a.left_btn {
