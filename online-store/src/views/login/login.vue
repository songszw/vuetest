      ...
      <div class="login-box clearfix"
        ...
        <div class="fr form-box">
          ...
          <form id="jsLoginForm"
            ...
            <p class="error-text"
               v-show="userNameError">{{userNameError}}</p>
            <div class="form-group marb8">
              <label>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label>
              <input name="password_l"
                     id="password_l"
                     type="password"
                     v-model="parseWord"
                     @focus="errorUnshow"
          ...
          <ul class="form other-form">
            ...
            <li class="other-login">
              <a class="qq"
                 href="http://shop.projectsedu.com:8001/login/qq/"></a>
              <a class="sina"
                 href="http://shop.projectsedu.com:8001/login/weibo/"></a>
              <a class="weixin"
                 href="http://shop.projectsedu.com:8001/login/weixin/"></a>
            </li>
          </ul>
          <p class="form-p">
            没有帐号？
